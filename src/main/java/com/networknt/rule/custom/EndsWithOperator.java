...
public class EndsWithOperator implements CustomOperator {
    private static final Logger logger = LoggerFactory.getLogger(EndsWithOperator.class);
    ...
    public boolean evaluate(String ruleId, String conditionId, Object object, Object valueObject, List<RuleConditionValue> conditionValues) throws RuleEngineException {
        ...
        if (object instanceof String && valueObject instanceof String) {
            return ((String) object).endsWith((String) valueObject);
        } else {
            String errorMsg = "EndsWith evaluation with type different than string " + object.getClass();

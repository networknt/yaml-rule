...
public class BigDecimalTypeOperation implements TypeSpecificOperation<BigDecimal> {
    private static final Logger logger = LoggerFactory.getLogger(BigDecimalTypeOperation.class);
    @Override
    public BigDecimal convert(String ruleId, String conditionId, Object object, String valueStr, String dateFormat) throws RuleEngineException {
        return new BigDecimal(valueStr);
    }
    @Override
    public int compare(String ruleId, String conditionId, Object object, Object valueObject) throws RuleEngineException {
        if(!(object instanceof BigDecimal)) return 0;
        Object value = valueObject;
        if(valueObject instanceof String) {
            try {
                value = convert(ruleId, conditionId, object, (String)valueObject, null);
            } catch(Exception e) {
                String errorMsg = "value " + valueObject + " is not a BigDecimal.";
        ...
        if(!(value instanceof BigDecimal)) return 0;

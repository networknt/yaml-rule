...
public class ConfigServerAuthTest {
    ...
    /**
     * The token is client credentials, and it has a sid claim to access the config server, and the service-name in the path
     * parameter matches the jwt sid claim. The result should be true.
     *
     * One of the conditions is to check the jwt token sid claim equals to the pathParameters service-name in the request. It
     * is the only way to ensure that it is the right service to get its configuration.
     *
     * @throws Exception
     */
    @Test
    public void testAuthWithCcTokenWithSidRightPathParam() throws Exception {
    ...
    /**
     * The token is client credentials, and it has a sid claim to access the config server, and the service-name in the path
     * parameter matches the jwt sid claim. The result should be false as the path parameter is not the same as the JWT sid
     * claim.
     *
     * One of the conditions is to check the jwt token sid claim equals to the pathParameters service-name in the request. It
     * is the only way to ensure that it is the right service to get its configuration.
     ...
     */
    @Test
    public void testAuthWithCcTokenWithSidWrongPathParam() throws Exception {
        String jwt = "eyJraWQiOiIxMDAiLCJhbGciOiJSUzI1NiJ9..W5oRWYy6uLGkXysQbekdlGc92kaW1OXq_eGpoEcWbw13xd9bpAid0aiHxXTvOh1vArce2lZ46K1Zcpo0vF456_O4qmwX-dyAqqcWlca9MG5Juo1oh1-QYMKfm3lpj2VeqpQ4LSF2C3LvX6zRjCvM7_2S9i12pBu7-oyJp9QZsYc1tmp5PK7EoFwSLUUk28SiEuY_gtmUkCHMakwLYkOK-4XQyMbFfLB-Ft-ZD2FC8UNvjNFGBCXUyCL071AZ7DpmOela4uNMLChBVZIxYULFEQVwA5c8jQwxa3uXr8-mg9S36jziRYf-CBZu51ig8vI1yphcyqRWruqJ_7A3XW0AFQ";
        RuleEngine engine = new RuleEngine(ruleMap, null);
        Map objMap = new HashMap();
        Map<String, Object> auditInfo = new HashMap();
